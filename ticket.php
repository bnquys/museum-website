        ...
        <section class="container-fluid">
            ...
            <form class="container" id="ticketForm">
                ...
                >
                    ...
                    <button class="btn btn-warning pulse w-auto">~~~~~ Checkout !! ~~~~~</button>
                </div>
            </form>
        </section>
        <script>
            $(document).ready(function () {
                ...
                function calculateTotal() {
                    ...
                    // Calculate total for ticket quantities
                    ...
                    // Add the selected guide price to the total if any guide is selected
                    const selectedCard = document.querySelector(".guide-card.selected");
                    if (selectedCard) {
