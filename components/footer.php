<footer class="container-fluid">
	<div class="container text-white">
		<!-- Stay with email -->
		<div id="stay-with-us" class="d-flex align-items-center justify-content-center w-100 pt-5">
			...
			<form action="#" class="d-flex align-items-start justify-content-start w-50">
				...
				<input
					...
					id="InputEmail"
					placeholder="Email"
					style="box-shadow: none; height: 45px; text-color: white"
				/>
				<button
					type="submit"
		...
		<div class="row align-items-end mb-3">
			<div class="col-md-6 d-flex align-items-end mb-3 mb-md-0">
				...
				/>
				<div class="ms-2">
				<h5 class="mb-0 fw-bold fs-7">Our</h5>
				<h4 class="fw-bold fs-7">MUSEUM</h4>
				</div>
			</div>
			...
			<div class="col-md-6 text-md-end text-start">
				...
				<a href="#" class="text-white me-3">Trip Advisor</a>
    	...
    	<!-- Bottom Row -->
		<div class="row justify-content-between align-items-center pt-2 pb-4">
		<div class="col-md-8 d-flex flex-wrap gap-3">
			<a href="#" class="text-white text-decoration-none">Privacy Policy</a>
			<a href="#" class="text-white text-decoration-none">Social Media Policy</a>
			<a href="#" class="text-white text-decoration-none">Terms of Use</a>
		</div>
		<div class="col-md-4 text-md-end text-start mt-3 mt-md-0">
			<small>&copy; 2025 Our Museum. All Rights Reserved.</small>
		</div>
		</div>
	</div>
</footer>